  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        casitadigitalE1: resolve(root, 'casita_digital_06/index.html'),
        casitadigitalE1: resolve(root, 'casita_digital_07/index.html'),
        casitadigitalE1: resolve(root, 'casita_digital_08/index.html'),
